...
click('toSetup'); click('startGame');
click('toWorkbench');
console.log('\n=== 第1章 工作台 ===');
console.log('目标:', grab(appEl.innerHTML,'wb-goal-line'));

click('enterChapter');
console.log('场景:', grab(appEl.innerHTML,'scene-bar'));
console.log('情境:', grab(appEl.innerHTML,'stage-situation'));
...
for(let c=2;c<=5;c++){ click('toWorkbench'); click('enterChapter'); click('makeDecision',null,'0'); click('publish'); click('authorDecide',null,'0'); }
